...
/*
Observe cómo cambian las propiedades CSS cuando las usamos desde JavaScript:

background-color (CSS) se convierte en backgroundColor (JS)
margin-left (CSS) se convierte en marginLeft (JS)
etc.
Y las posiciones, anchos y alturas son siempre valores de cadena. En nuestro ejemplo utilizamos unidades de píxeles y un porcentaje, por lo que debemos agregar los caracteres "px" y "%" cuando manipulamos estas propiedades desde JavaScript.
